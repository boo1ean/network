...
<?php
    ...
    echo $form->field($model, 'email')->textInput(array('value' => $model->user->email, 'id' => 'email'));
    ...
    echo $form->field($model, 'first_name')->textInput(array('value' => $model->user->first_name, 'id' => 'first_name'));
    echo $form->field($model, 'last_name')->textInput(array('value' => $model->user->last_name, 'id' => 'last_name'));
