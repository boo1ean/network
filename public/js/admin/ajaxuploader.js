...
(function($){
    ...
    Ajax_upload.prototype = {
        ...
        create_wrapper : function(){
            ...
            wrapper = this.wrapper = $('<div width="auto"></div>')
                .insertAfter(button)
                .append(button);
            ...
            wrapper.mousemove(function(e){
                ...
                var height=e.pageY - wrapper.offset().top;
                var width=e.pageX - wrapper.offset().left;
                if (!self.input||height>wrapper.height()||height<0||width>wrapper.width()||width<0) {
                    return;
                }

                self.input.css({
                    top: e.pageY - wrapper.offset().top - 5 + 'px'
                    ,left: e.pageX - wrapper.offset().left - 103 + 'px'
                });
            });
